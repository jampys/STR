...
public class JAVADUINO_Frame extends javax.swing.JFrame {
    ...
    public JAVADUINO_Frame() {
        ...
        inicializarConexion();
        jLabel1.setIcon(new ImageIcon("src/pruebas/encendidoLed/IconoLedRojoApagado.png"));
        jLabel3.setIcon(new ImageIcon("src/pruebas/encendidoLed/IconoLedAmarilloApagado.png"));    
        setTitle("JAVADUINO");
        jRadioButton1.setSelected(true);
    }
    
    public void inicializarConexion(){ //inicializa la conexion con arduino
        ...
        if(puertoID==null){
            mostrarError("ERROR - No se puede conectar al puerto");
            System.exit(ERROR);
        }
        
        try{
            serialPort = (SerialPort) puertoID.open(this.getClass().getName(), TIMEOUT); //abre el puerto serie
            
            //Parámetros puerto serie
            serialPort.setSerialPortParams(DATA_RATE, SerialPort.DATABITS_8, SerialPort.STOPBITS_1, SerialPort.PARITY_NONE);
            
            output = serialPort.getOutputStream(); //para abrir el flujo de datos
    ...
    private void enviarDatos(String datos){ //este metodo envia los datos al arduino
        try{
            output.write(datos.getBytes());
        } catch(Exception e){
            mostrarError("ERROR - No se pueden enviar los datos");
            System.exit(ERROR);
        }
    }    
    
    public void mostrarError(String mensaje){ //solo muestra el mensaje de error por pantalla
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if(jRadioButton1.isSelected()){
            ...
            jLabel1.setIcon(new ImageIcon("src/pruebas/encendidoLed/IconoLedRojo.png"));
        }
        if(jRadioButton2.isSelected()){
            /*enviarDatos(TURN_Amarillo_ON);
            jLabel3.setIcon(new ImageIcon("src/pruebas/encendidoLed/IconoLedAmarillo.png")); */
        }
